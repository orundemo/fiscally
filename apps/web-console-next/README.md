...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Fiscally web console.
...
- Per-env Cloudflare Pages projects: `fiscally-web-console-next-{dev,stage,prod}`
