 ...
 * signature verifier for Fiscally outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Fiscally webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Fiscally webhook delivery.
 *
