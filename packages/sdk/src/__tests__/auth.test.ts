...
//   - FiscallyError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Fiscally {
  return new Fiscally({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Fiscally class", () => {
