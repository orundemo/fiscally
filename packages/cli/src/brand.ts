...
// `@saas/sdk` client class name (`Fiscally`) is intentionally NOT part of
...
export const CLI_BIN = "fiscally";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Fiscally";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.fiscally.dev";
