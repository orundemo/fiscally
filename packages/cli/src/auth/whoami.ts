// `fiscally whoami` — read token + cached context, validate via SDK.
...
export interface WhoamiInput {
  ...
  /** SDK factory override for tests. Defaults to constructing `Fiscally`. */
  readonly sdkFactory?: (baseUrl: string, token: string) => Fiscally;
}
