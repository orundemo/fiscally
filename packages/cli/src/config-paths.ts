...
//   - `~/.config/fiscally/credentials.json` (0600)
//   - `~/.config/fiscally/config.json`     (0644)
//
// Override via `FISCALLY_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/fiscally` everywhere
