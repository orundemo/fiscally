// `fiscally webhook verify` — local cryptographic verification of a
// Fiscally outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `fiscally login`.
